...
namespace LuxuryLife.Areas.ProviderUser.Controllers
{
    ...
    public class VouchersController : Controller
    {
        ...
        // GET: ProviderUser/Vouchers
        public async Task<IActionResult> Index()
        {
            return View(await _context.Vouchers.ToListAsync());
        }

        // GET: ProviderUser/Vouchers/Details/5
        ...
        // GET: ProviderUser/Vouchers/Create
        public IActionResult Create()
        {
            return View();
        }

        // POST: ProviderUser/Vouchers/Create
        ...
        // GET: ProviderUser/Vouchers/Edit/5
        ...
        // POST: ProviderUser/Vouchers/Edit/5
        // To protect from overposting attacks, enable the specific properties you want to bind to.
        // For more details, see http://go.microsoft.com/fwlink/?LinkId=317598.
        [HttpPost]
        [ValidateAntiForgeryToken]
        ...
        // GET: ProviderUser/Vouchers/Delete/5
        ...
        // POST: ProviderUser/Vouchers/Delete/5
